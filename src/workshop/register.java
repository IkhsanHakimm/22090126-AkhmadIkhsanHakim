...
public class register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Ilustrasi-Workshop-sumber-Transat (1).png"))); // NOI18N

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/18777 (1).png"))); // NOI18N
    ...
    private void BtnRegisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRegisActionPerformed
        ...
        try {
           ...
           if (txtUsername.getText().equals("") || txtPassword.getText().equals("")|| txtFullname.getText().equals("")
                   || txtEmail.getText().equals("") || txtContact.getText().equals("")|| txtAddress.getText().equals("")){
                JOptionPane.showMessageDialog(null, "maaf data harus di isi");
                return;
           }
           String cekQuery = "SELECT * FROM tabel_peserta WHERE username = '" + txtUsername.getText() + "' AND password = '" + txtPassword.getText() + "' AND nama_peserta = '" + 
                   txtFullname.getText() +"' AND email_peserta = '" + txtEmail.getText() +"' AND alamat_peserta = '" + txtAddress.getText() + "' AND nomor_telepon = '"+ txtContact.getText() + "'";
